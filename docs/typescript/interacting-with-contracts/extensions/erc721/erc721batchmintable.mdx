...
const walletAddress = "{{0x2B5C1DfB3beF4DEb303bC0a95AADF0AE1C9ef414}}";

// Custom metadata of the NFTs you want to mint.
const metadatas = [
  {
    name: "GBADUN #1",
    description: "This is a GBADUN NFT",
    image: "https://i.seadn.io/gcs/files/3dbeeba96457963bee33749894e0f9a5.jpg?auto=format&dpr=1&w=256", // URL, IPFS URI, or File object
